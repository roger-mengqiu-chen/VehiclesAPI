...
@ApiResponses({@ApiResponse(
        ...
        code = 500,
        message = "The server is down. Please make sure that the Location microservice is running."
)})
@RequestMapping("/cars")
class CarController {
    ...
    ResponseEntity<?> post(@Valid @RequestBody Car car) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI(resource.getLink("self").get().getHref())).body(resource);
    }
